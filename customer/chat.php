<?php
/**
 * Customer - Chat with Lawyer
 * 
 * Displays chat history for a specific appointment.
 * Allows customer to send messages to the lawyer.
...
// ============================================================
// 3. Fetch appointment details (verify it belongs to this customer)
// ============================================================
...
// ============================================================
markMessagesAsRead($appointment_id, $user_id, 'customer');
        ...
        <div class="dashboard-card" style="padding:0; overflow:hidden;">
            ...
            <div class="chat-container">
                ...
                <div class="chat-header">
                    ...
                    <?php endif; ?>
                    <div>
                        <h5><?php echo htmlspecialchars($lawyer_name); ?></h5>
                        <span class="status"><?php echo htmlspecialchars($appointment['specialization']); ?> Specialist</span>
                    </div>
                ...
                <div class="chat-messages" id="chatMessages">
                    <?php if (count($messages) > 0): ?>
                        <?php foreach ($messages as $msg): ?>
                            <?php 
                            $is_sent = ($msg['sender_id'] == $user_id && $msg['sender_type'] == 'customer');
...
function displayMessages(messages) {
    ...
    if (messages.length === 0) {
        ...
        messages.forEach(function(msg) {
            let side = (msg.sender_id == userId && msg.sender_type == 'customer') ? 'sent' : 'received';
